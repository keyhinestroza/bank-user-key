...
public class UsersServiceImpl implements  UsersService {
	...
	public void delete(Users entity) throws Exception {
		...
		findById(entity.getUserEmail()).ifPresent(user->{
			if(user.getAccounts()!=null && user.getAccounts().isEmpty()==false) {
				throw new RuntimeException("El usuario tiene cuentas asociadas");
			}
			
			if(user.getRegisteredAccounts()!=null && user.getRegisteredAccounts().isEmpty()==false) {
				throw new RuntimeException("El usuario tiene cuentas registradas asociadas");
			}		
		});
		*/
